...
// Komponenta za animirani input sa plutajućom etiketom, ikonicama i validacijom
// Props:
// label: tekst etikete
// value: vrednost inputa
// onChange: funkcija za promenu vrednosti
// onBlur: funkcija koja se poziva pri gubitku fokusa (opciono)
// type: tip inputa (text, password, email, itd.)
// placeholder: placeholder tekst
// error: tekst greške (ako postoji)
// success: tekst uspeha (ako postoji)
// required: da li je polje obavezno
// disabled: da li je polje onemogućeno
