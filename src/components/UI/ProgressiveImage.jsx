...
export default function ProgressiveImage({ src, alt = "", className = "", style = {}, fit = "cover" }) {
    ...
    >
      <img
        ...
        className={`${fitClass} transition-all duration-500 ease-out
          ${loading ? "blur-2xl grayscale scale-105 opacity-30" : "blur-0 scale-100 opacity-100 shadow-lg animate-imgfadein"}
      ...
      {loading && (
        <div className="absolute inset-0 flex items-center justify-center z-10 bg-gradient-to-br from-white/30 via-bluegreen/10 to-blue-100/20">
          <div className="w-12 h-12 sm:w-16 sm:h-16 border-[4px] border-t-bluegreen border-l-bluegreen/70 border-b-blue-300 border-r-transparent rounded-full
