...
export const SEO_CONFIGS = {
  home: {
    ...
    description:
      "Profesionalan servis za vage - žigosanje, overavanje, kalibrisanje i softverska rešenja. Ovlašćeni servis sa 20+ godina iskustva. Pozovite nas danas!",
    keywords:
  ...
  usluge: {
    ...
    keywords: [
      ...
      "akreditovano kontrolno telo", "SRPS ISO/IEC 17020", "ATC 06-373",
      "kontrolno telo tipa C", "etalonirani tegovi", "25 tona tegova",
      "kamionska vaga overa", "kamionske vage", "industrijske vage",
    ...
    structuredData: [
      {
        ...
        identifier: [{ "@type": "PropertyValue", propertyID: "ATS Accreditation No.", value: "06-373" }],
        hasCredential: [
          { "@type": "EducationalOccupationalCredential", name: "SRPS ISO/IEC 17020", identifier: "ATC 06-373" },
        ],
        serviceType: [
  ...
  onama: {
    ...
    description:
      "Saznajte više o Vaga Beta - našoj istoriji, vrednostima i timu koji čini razliku u industriji vaga. 20+ godina iskustva.",
