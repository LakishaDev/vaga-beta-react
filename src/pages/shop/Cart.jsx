...
export default function Cart() {
  ...
  return (
    <>
      <div className="w-full px-4 sm:px-8 md:px-16 py-6 sm:py-8 bg-neutral-bg animate-fadeIn">
        <div className="rounded-3xl border border-neutral-border bg-white shadow-xl p-3 sm:p-6 md:p-10">
          <h2 className="flex items-center gap-2 sm:gap-4 text-xl sm:text-2xl md:text-3xl font-heading font-extrabold mb-5 md:mb-8 text-brand-primary">
            <FaShoppingCart className="text-brand-secondary" size={28} />
          ...
          {cart.length === 0 ? (
            <div className="flex flex-col items-center py-6 sm:py-10 text-base sm:text-xl text-gray-400 animate-jump">
              ...
              <Link
                ...
                className="mt-6 text-brand-primary underline"
              >
                Nastavi kupovinu
              </Link>
            </div>
            ...
            <>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-end gap-1 sm:gap-2 w-full sm:w-auto">
                      {hasHiddenPrice(item) ? (
                        ...
                        <span
                          className={`text-base sm:text-xl font-bold text-text-primary ${
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          className="ml-2 flex items-center gap-1 bg-error text-white py-1 px-2 sm:px-3 rounded hover:brightness-95 transition-all shadow active:scale-95"
                          onClick={() => {
                            setRemoveId(item.id);
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-0 font-semibold text-xl sm:text-2xl my-5 border-t pt-4">
                <span>Ukupno:</span>
                <span
                  className={`text-brand-primary ${animatingTotal ? "animate-flipPrice" : ""}`}
                >
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
                <Link
                  ...
                  className="flex items-center justify-center gap-2 bg-brand-primary text-white px-6 py-2 sm:px-8 sm:py-3 rounded-xl sm:rounded-2xl shadow-lg hover:bg-brand-primary-hover transition-all scale-100 active:scale-95 text-base sm:text-lg"
                >
                  <FaCheckCircle className="text-white" size={18} />
                  Nastavi na plaćanje
                </Link>
                <button
                  className="flex items-center justify-center gap-2 bg-text-primary text-white px-6 py-2 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl shadow-lg hover:bg-slate-800 transition-all scale-100 active:scale-95 text-base sm:text-lg"
