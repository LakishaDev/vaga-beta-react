...
import ScrollToHashOrTopOnMount from "../components/UI/ScrollToTopOnMount";

export default function Usluge() {
  return (
    <>
      <ScrollToHashOrTopOnMount offset={-120} duration={1.2} useHash />
      <main className="max-w-6xl mx-auto bg-gradient-to-b from-[#F9FAF9] to-[#EEF3EF] rounded-3xl shadow-2xl p-10 sm:p-16 mt-16 border border-[#D7DACF] animate-fadein overflow-hidden">
        <div className="text-center mb-14 animate-pop">
          ...
          <p className="text-[#2F5363] text-lg mt-2 max-w-3xl mx-auto">
            Pouzdano održavanje, zakonska verifikacija i digitalna
            transformacija vaga – sve na jednom mestu.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <section className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 p-8 border border-[#D8E2DC] animate-slidein-left">
            ...
            <p className="text-[#2F5363] mb-4 leading-relaxed">
              Stručno servisiranje, kalibracija i održavanje vaga – od
              trgovinskih do industrijskih i kamionskih sistema. Naš tim
              obezbeđuje preciznost i dugotrajnost svakog merila.
            </p>
          ...
          <section className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 p-8 border border-[#D8E2DC] animate-slidein-left">
            ...
            <p className="text-[#2F5363] mb-4 leading-relaxed">
              ...
              <FaApple className="inline text-[#1E3E49]" /> iOS), desktop
              softver i baze za digitalno upravljanje merenjima, analizu i
              izveštavanje.
            </p>
            <div className="flex items-center gap-2 text-[#AD5637] font-medium">
          ...
          <section className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-500 p-8 border border-[#D8E2DC] animate-slidein-right">
            ...
            <p className="text-[#2F5363] mb-4 leading-relaxed">
              Cloud rešenja za skladištenje, API integracije i nadzor vaga sa
              bilo kog mesta. Povezivanje sa ERP/CRM sistemima i generisanje
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-10 relative">
            ...
            <div className="md:w-1/2 bg-white/80 p-8 rounded-2xl shadow-md border border-[#D8E2DC] animate-slidein-right">
              ...
              <p className="text-[#2F5363] mt-3 italic">
                ...
                obično <b>24 meseca</b> od datuma žigosanja, nakon čega mora da
                se izvrši ponovna verifikacija.
              </p>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-start gap-4 mt-2">
                ...
                <div className="text-[#AD5637] font-semibold">
                  Svi koraci izvode se od strane akreditovanog kontrolnog tela,
                  uz striktno poštovanje propisa Republike Srbije.
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mt-16 animate-fadein">
          ...
          <ul className="flex flex-wrap justify-center gap-6 text-lg font-medium">
            <li className="flex gap-2 items-center">
              <FaTools className="text-[#6EAEA2]" /> Savremen servis i stručan
              tim
            </li>
            <li className="flex gap-2 items-center">
            ...
            <li className="flex gap-2 items-center">
              <FaCloud className="text-[#AD5637]" /> Cloud i daljinsko
              upravljanje
            </li>
            <li className="flex gap-2 items-center">
            ...
            <li className="flex gap-2 items-center">
              <FaPlug className="text-[#AD5637]" /> Integracije sa vašim
              sistemima
            </li>
          </ul>
        </section>
