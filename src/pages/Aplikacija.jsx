    ...
    <main className="max-w-6xl mx-auto bg-white/95 rounded-xl shadow-2xl p-6 sm:p-10 mt-14 border border-[#CBCFBB] animate-fadein">
      ...
      <section className="mb-8 animate-fadeup">
        ...
        <p className="text-[#2F5363] text-lg mb-3 leading-relaxed">
          ...
          skladištu ili na terenu, sada možete lako kreirati zahteve, zakazivati
          servise i pratiti istoriju održavanja vaših vaga —{" "}
          <b>sve sa vašeg telefona</b>.
        </p>
        <p className="text-[#2F5363] text-lg leading-relaxed">
          Aplikacija je trenutno u{" "}
          <span className="font-bold text-[#AD5637]">ranom pristupu</span>, što
          znači da možete biti među prvima koji će isprobati i uticati na njen
          razvoj. Pridružite nam se i dopustite nam da zajedno izgradimo
          ...
          <div className="flex-1">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-[#CBCFBB] text-sm">
                    Svi podaci između aplikacije i programa su potpuno zaštićeni
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/10">
                ...
                <div>
                  <h4 className="font-bold text-white mb-1">Isti korisnici</h4>
                  <p className="text-[#CBCFBB] text-sm">
            ...
            <div className="p-4 rounded-xl bg-[#91CEC1]/20 border border-[#91CEC1]/30">
              <p className="text-white text-sm">
                ...
                pretplata. Desktop program i aplikacija rade zajedno i dele istu
                bazu podataka.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          >
            ...
            <div className="relative p-6">
              ...
              <p className="text-[#2F5363]">
                Komunicirajte sa našim timom direktno kroz aplikaciju. Postavite
                pitanja, dobijte savete i pratite status vašeg zahteva u realnom
                vremenu.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex items-start gap-4 p-5 rounded-xl bg-gradient-to-br from-[#6EAEA2]/10 to-[#91CEC1]/5 border border-[#6EAEA2]/20 hover:border-[#6EAEA2] transition-all duration-300 hover:shadow-lg animate-slidein-left">
            ...
            <div>
              ...
              <p className="text-[#2F5363]">
                Smanjite vreme čekanja i elimišite nepotrebne telefonske pozive.
                Sve što vam je potrebno je na dohvat ruke.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[#2F5363]">
                Pratite svaki korak procesa i imajte potpunu kontrolu nad vašim
                servisima i zahtevima.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[#2F5363]">
                Vaša istorija, preferencije i podaci su sačuvani za brži i lakši
                pristup.
              </p>
            </div>
          </div>
          ...
          <div className="relative p-8 sm:p-12 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg text-[#CBCFBB] mb-8 leading-relaxed">
                ...
                najbolje rešenje za upravljanje vagama. Preuzimanjem aplikacije
                u ranom pristupu, dobijate priliku da uticaćete na njen budući
                razvoj.
              </p>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-[#2F5363] leading-relaxed">
              Aplikacija je trenutno u fazi ranog pristupa, što znači da aktivno
              radimo na njenom unapređenju. Vaše povratne informacije su nam
              izuzetno važne! Ako primetite bilo kakve probleme ili imate
              sugestije, slobodno nas{" "}
              <Link
                to="/kontakt"
