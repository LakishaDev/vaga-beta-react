  ...
  return (
    <main className="max-w-5xl mx-auto bg-white/90 rounded-xl shadow-2xl p-6 sm:p-10 mt-12 border border-[#CBCFBB] flex flex-col md:flex-row gap-8 items-stretch animate-fadein">
      ...
      <section className="flex-1 flex flex-col justify-between animate-slidein-left">
        <div>
          <h2 className="text-4xl text-[#1E3E49] font-bold mb-2 animate-pop">Kontaktirajte nas</h2>
          <p className="text-[#2F5363] mb-4 text-lg animate-fadeup">
            Pišite, pozovite ili svratite do naše laboratorije – <span className="font-bold text-[#AD5637]">Vaga Beta</span> tim je tu da svakom klijentu obezbedi pouzdanu podršku, brzu realizaciju i profesionalni odnos.
          </p>
          <ul className="space-y-2 text-[#1A343D] text-base font-semibold mb-4 animate-fadein">
            <li className="flex gap-2 items-center"><span role="img" aria-label="location">📍</span> <strong>Adresa:</strong> Ive Andrića 14, Niš 18116</li>
            <li className="flex gap-2 items-center"><span role="img" aria-label="man">👨‍💼</span> <strong>Aleksandar:</strong> <span className="text-[#91CEC1]">063 833 9686</span></li>
            <li className="flex gap-2 items-center"><span role="img" aria-label="man">👨‍🔧</span> <strong>Radoslav:</strong> <span className="text-[#6EAEA2]">063 810 6322</span></li>
            <li className="flex gap-2 items-center"><span role="img" aria-label="phone">📞</span> <strong>Telefon:</strong> <span className="text-[#2F5363]">018 4545 782</span></li>
            <li className="flex gap-2 items-center"><span role="img" aria-label="email">✉️</span> <strong>Email:</strong>
              <a href="mailto:vaga.beta@yahoo.com" className="text-[#AD5637] underline hover:text-[#6EAEA2] transition-colors">vaga.beta@yahoo.com</a>
            </li>
          </ul>
        </div>
