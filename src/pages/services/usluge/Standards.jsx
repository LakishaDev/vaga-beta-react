    ...
    <section style={standardsStyles.section} data-screen-label="standards">
            ...
            <article
              ...
              style={{
                ...
                ...(isPrimary ? {
                  ...
                  background: "linear-gradient(135deg, rgba(212,181,116,0.06) 0%, rgba(10,23,64,0.55) 100%)",
                } : {}),
              }}
            >
              {isPrimary ? (
                <div style={{ display: "flex", gap: 16, alignItems: "flex-start", marginBottom: 14 }}>
                  <ATCSeal size={90} withGlow={true} />
                  <div>
      ...
      <dl style={{
        ...
        {[
          ...
          <div key={dt} style={{ display: "flex", gap: 8, alignItems: "baseline" }}>
            <dt style={{ color: "rgba(212,181,116,0.55)", whiteSpace: "nowrap" }}>{dt}:</dt>
